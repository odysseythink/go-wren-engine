...
type SqlBaseListener interface {
	...
	// EnterImpersonateUser is called when entering the impersonateUser production.
	EnterImpersonateUser(c *ImpersonateUserContext)
	...
	// EnterPgCast is called when entering the pgCast production.
	EnterPgCast(c *PgCastContext)
	...
	// EnterFunctionRelation is called when entering the functionRelation production.
	EnterFunctionRelation(c *FunctionRelationContext)
	...
	// EnterPosixComparison is called when entering the posixComparison production.
	EnterPosixComparison(c *PosixComparisonContext)
	...
	// EnterEscapedCharsStringLiteral is called when entering the escapedCharsStringLiteral production.
	EnterEscapedCharsStringLiteral(c *EscapedCharsStringLiteralContext)
	...
	// EnterQuotedRegexMatch is called when entering the quotedRegexMatch production.
	EnterQuotedRegexMatch(c *QuotedRegexMatchContext)
	...
	// ExitImpersonateUser is called when exiting the impersonateUser production.
	ExitImpersonateUser(c *ImpersonateUserContext)
	...
	// ExitPgCast is called when exiting the pgCast production.
	ExitPgCast(c *PgCastContext)
	...
	// ExitFunctionRelation is called when exiting the functionRelation production.
	ExitFunctionRelation(c *FunctionRelationContext)
	...
	// ExitPosixComparison is called when exiting the posixComparison production.
	ExitPosixComparison(c *PosixComparisonContext)
	...
	// ExitEscapedCharsStringLiteral is called when exiting the escapedCharsStringLiteral production.
	ExitEscapedCharsStringLiteral(c *EscapedCharsStringLiteralContext)
	...
	// ExitQuotedRegexMatch is called when exiting the quotedRegexMatch production.
	ExitQuotedRegexMatch(c *QuotedRegexMatchContext)
